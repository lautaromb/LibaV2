...
if($cantidadConsulta ==0){ 
    header("Location:formulario.php?errorEmail=1");
    exit();
}else{
$updateClave    = ("UPDATE usuario SET password='$contraseña' WHERE email='".$correo."' ");
...
$cuerpo .= '
    ...
    header("Location:formulario.php?email=1");
    exit();
}
